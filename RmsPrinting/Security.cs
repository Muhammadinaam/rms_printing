...
namespace RmsPrinting
{
    ...
    public class FingerPrint
    {
        ...
        public static string Value()
        {
            ...
            {
                fingerPrint = StringCipher.Encrypt("CPU: " + cpuId() + ", BIOS: " +
            biosId() + ", BASE: " + baseId()
                        //+"\r\nDISK >> "+ diskId() + "\r\nVIDEO >> " + 
                        //videoId() +"\r\nMAC >> "+ macId()
                        , "abc");
    ...
    public static class StringCipher
    {
        ...
        public static string OldEncrypt(string plainText, string passPhrase)
        {
        ...
        public static string OldDecrypt(string cipherText, string passPhrase)
        {
